  ...
  return (
    <main className='home'>
        ...
        <div className="left">
            ...
            <textarea name="jobDescription" id="jobDescription" placeholder='Enter a job description here...'></textarea>
        </div>
        <div className="right">
            ...
            <div className="input-group">
                ...
                <textarea name="selfDescription" id="selfDescription" placeholder='Describe yourself in a few sentence..'></textarea>
